#!/usr/bin/env python3
import socket,shutil,psutil,emails
...
def send_email(sub):
    email = emails.generate_email("automation@example.com", "student-01-2e175e2f136d@example.com",sub,"Please check your system and resolve the issue as soon as possible.", "")
